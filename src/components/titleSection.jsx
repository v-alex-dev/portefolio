...
const TitleSection = ({}) => {
    ...
    return (
        <div className={"flex flex-row md:w-full gap-4 items-center justify-between"}>
            <img src={'./src/assets/PhotCV.jpg'} alt={"Alexandre"} className={"md:w-full"}/>
            <div className={"text-left"}>
                ...
                <p>Mon engagement envers le développement web s'est consolidé lors d'un stage chez Barestho, où j'ai eu
