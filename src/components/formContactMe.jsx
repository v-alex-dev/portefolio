  ...
  return (
    <>
      ...
      <div className="w-screen h-screen  fixed top-0 left-0 flex items-center justify-center">
        <div className="w-1/2 h-1/2 bg-blue p-8 rounded shadow-lg flex flex-col items-center justify-center gap-4 relative">
          <a
            href="/"
            className="absolute top-0 right-0 p-4 rounded-full border border-orange text-white font-bold w-4 h-4 flex items-center justify-center hover:bg-orange mr-3 mt-3"
          >
            X
          </a>
          ...
          {isLoading ? (
            ...
            <>
              <a
                href="mailto:alex-dev-js-emploi@hotmail.com"
                target="_blank"
                rel="noreferrer"
                className="btn-popup"
              >
